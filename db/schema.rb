...
ActiveRecord::Schema[7.0].define(version: 2024_03_19_104415) do
  ...
  create_table "shipping_informaitons", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["purchase_record_id"], name: "index_shipping_informaitons_on_purchase_record_id"
  end
  ...
  add_foreign_key "shipping_informaitons", "purchase_records"
end
